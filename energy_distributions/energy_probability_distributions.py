...
for composition in compositions:
    ...
    #  Get mask of CO and NO not blocked by H
    ...
    # Set same limit for all compositions
    ...
    # Plot probabiliy density on axes object
    ...
    # Linear regression parameters obtained in DFT_scaling
    a = 1.88
    b = - 0.94

    # Plot dG=0 lines and H equilibrium line
    ...
    # Plot single metal energies within plot
