...
with connect("CO_out.db") as db, connect('slabs_out.db') as slab_db:
    for row in db.select():
        ...
        # If nearest site is not top site, skip the current structure
